...
欢迎来到 Robocon！为了让你的机器人“活”起来，我们首先要为它的大脑安装一个操作系统——ROS 2。
...
### :question: 第二部分：什么是 ROS 2？ (10 分钟)
  ...
  * **核心比喻**：把 ROS 2 想象成一个专为机器人设计的 **“城市”**。
      * **你的代码**：城市里的各种“建筑”，比如“避障大楼”、“抓取工厂”等。
      * **ROS 2**：管理这个城市的“城市管理者”，它提供道路、电力、通信网络等基础设施，让所有建筑都能高效运转。
...
这一部分是课程的重点，需要用最生动的语言解释 ROS 2 的基本组成部分。
